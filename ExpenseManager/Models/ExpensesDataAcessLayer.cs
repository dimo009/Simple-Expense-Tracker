    ...
    public class ExpensesDataAcessLayer
    {
        ...
        public Dictionary<string, decimal> CalculateMonthlyExpense()
        {
            ...
            decimal healthSum = db.ExpenseReport.Where
               ...
               .Select(cat => cat.Amount)
               .Sum();
            decimal drinkSum = db.ExpenseReport.Where
              (cat => cat.Category == "Drink" && (cat.ExpenseDate > DateTime.Now.AddMonths(-7)))
              .Select(cat => cat.Amount)
              .Sum();
            ...
            dictMonthlySum.Add("Drink", drinkSum);
        ...
        public Dictionary<string, decimal> CalculateWeeklyExpense()
        {
            ...
            decimal healthSum = db.ExpenseReport.Where
               ...
               .Sum();
            decimal drinkSum = db.ExpenseReport.Where
              (cat => cat.Category == "Drink" && (cat.ExpenseDate > DateTime.Now.AddMonths(-28)))
              .Select(cat => cat.Amount)
              .Sum();
            ...
            dictWeeklySum.Add("Drink", drinkSum);
